 ...
 * @author drakeet
 */
public class DataType2ViewProvider
    extends ItemViewProvider<Data, DataType2ViewProvider.ViewHolder> {
    ...
    protected void onBindViewHolder(
        @NonNull DataType2ViewProvider.ViewHolder holder, @NonNull Data data) {
